...
const Footer = () => {
    ...
    return (        
        <div className="footer-outer-wrapper" id={
            showDetail.toString()} style={{
                backgroundColor : showDetail ? "rgba(0,0,0,0.4)" : "",
                position : showDetail ? "absolute" : "static",
                width : showDetail ? "100vw" : "",
                height : showDetail ? "100vh" : "",
                zIndex : showDetail ? "100" : "1",
                top : 0,
                left : 0,
            }}>
            <div className="footer-wrapper">
                ...
                { !showDetail && (
                <div className="short">
                    <div className="short-footer-span">
                        <span>2022 Daily Record</span>
                        <span>Made by <span className="footer-github-link" onClick={() => window.open("https://github.com/jiinmozzi/daily-record")}>Jiinmozzi</span></span>
                    </div>
